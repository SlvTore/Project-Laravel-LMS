...
<head>
	...
	<title>Instructor - Reset Password</title>
</head>
                                    ...
                                    <div class="ps-3">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb mb-0 p-0">
                                                <li class="breadcrumb-item"><a href="{{ route('instructor.index') }}"><i class="bx bx-home-alt"></i></a></li>
                                    ...
                                    <form action="{{ route('instructor.update.password') }}" method="POST">
                                        @csrf
                                            ...
                                            <div class="d-grid gap-2">
                                                ...
                                                <a href="{{ url('/instructor/dashboard') }}" class="btn btn-light mt-3"><i class='bx bx-arrow-back mr-1'></i>Back to Dashboard</a>
                                            </div>
                                    </form>
								</div>
							</div>
