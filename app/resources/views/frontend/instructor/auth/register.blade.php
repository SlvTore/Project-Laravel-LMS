        ...
        <div class="row pt-50px">
            <div class="col-lg-10 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        <form method="post" action="{{ route('instructor.register.save') }}" class="row" >
                            @csrf
                            <div class="input-box col-lg-6">
                                <label class="label-text">Name</label>
                                <div class="form-group">
                                    <input class="form-control form--control @error('username') is-invalid @enderror" type="text" name="username" value="{{ old('username') }}" placeholder="e.g. Alex">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input id="address" class="form-control form--control @error('address') is-invalid @enderror" type="text" name="address">
                                    @error('address')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                             ...
                             <div class="input-box col-lg-12">
                              ...
                              <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input id="password_confirmation" class="form-control form--control" type="password" name="password_confirmation">
                                </div>
                            </div><!-- end input-box -->
