				...
				<nav class="navbar navbar-expand gap-3">
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{ (!empty($profileData->photo)) ? url('images/admin/'. $profileData->photo) : url('images/admin/img-profile.jpg') }}" class="user-img" alt="user avatar">
							<div class="user-info">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item d-flex align-items-center" href="{{ route('admin.reset.password') }}"><i class="bx bx-lock-open fs-5"></i><span>Reset Password</span></a>
							</li>
