							...
							<div class="card-body p-4">
								...
								<form id="myForm" action="{{ route('store.category') }}" method="POST" class="row g-3" enctype="multipart/form-data">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" name='category_name' class="form-control" id="category_name" placeholder="First Name" value="{{ $category->category_name }}">
									</div>
                                    ...
                                    <div class="col-md-6">
                                         <img id="showImage" src=" {{ asset($category->image) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
